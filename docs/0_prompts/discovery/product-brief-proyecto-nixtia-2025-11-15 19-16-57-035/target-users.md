...
## Primary Users: End Customers (Nixtia's Buyers)
...
- **Trust-based purchasing:** Buy from personal recommendations and known brands
...
4. Arrange payment (often cash on delivery)
...
4. Checkout with phone number (no account required)
5. Choose payment method (bank transfer, cash/card on delivery, or Stripe)
6. Receive order confirmation
7. Optional: Continue via WhatsApp for delivery coordination

## Secondary Users: Business Owner (Nixtia)
...
- **Secure access:** Email/password authentication with recovery flows
- **Mobile accessibility:** Manage business from phone when away from desk
